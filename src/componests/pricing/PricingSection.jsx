        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8 flex flex-col justify-center items-center">
                ...
                <div
                  className={`mt-10 flex items-center gap-x-2 ${
                    showAddToCart || showCancel ? "hidden" : "flex"
                  }`}
                ></div>
                <div className={`mt-10 ${showAddToCart ? "block" : "hidden"}`}>
                  <a
                    href="#"
                    onClick={addToCart}
